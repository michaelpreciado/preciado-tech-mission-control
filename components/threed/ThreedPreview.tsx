...
export function ThreedPreview() {
  ...
  return <main className="a2-gallery">
    <style>{`
      .a2-gallery { background:#07080b; color:#f4f7fb; min-height:100vh; padding:40px clamp(16px,4vw,64px); font-family:var(--pt-font-mono); }
      .a2-gallery h1,.a2-gallery h2 { color:#f4f7fb !important; text-shadow:none !important; }
      ...
      .a2-card { border:1px solid rgba(157,180,236,0.16); background:linear-gradient(140deg,#0b0d12,#07080b 68%); border-radius:18px; overflow:hidden; min-width:0; }
      ...
      .a2-card header span { color:#9db4ec; font-size:9px; letter-spacing:1.5px; }
      .a2-stage { height:310px; display:flex; align-items:center; justify-content:center; padding:0 12px; }
      .a2-footer { min-height:59px; border-top:1px solid rgba(255,255,255,0.08); padding:16px 24px; display:flex; align-items:center; justify-content:space-between; gap:12px; color:#99a3b2; font-size:10px; }
      .a2-gallery button:focus-visible,.a2-gallery input:focus-visible { outline:2px solid #9db4ec; outline-offset:3px; }
      .a2-next { border:1px solid rgba(157,180,236,0.35); border-radius:5px; padding:6px 9px; background:#0b0d12; color:#9db4ec; cursor:pointer; font:inherit; }
    ...
    <p style={{ maxWidth: 1320, margin: '22px auto 0', color: '#6f7886', fontSize: 9, letterSpacing: 1.3 }}>PROCEDURAL GEOMETRY · REALTIME WEBGL · NO EXTERNAL ASSETS</p>
  </main>
}
