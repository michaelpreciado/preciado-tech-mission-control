...
export function HomeDeck() {
  return <div className={`${styles.home} mc-home-workspace`}>
    <nav className="w2l-home-jumps" aria-label="Home sections"><a className="mc-btn" href="#home-conversation">Chat ↓</a><a className="mc-btn" href="#home-open-tasks">Tasks ↓</a></nav>
